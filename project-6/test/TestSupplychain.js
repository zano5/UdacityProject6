...
contract('SupplyChain', function(accounts) {
    ...
    const originFarmName = "Zanoxolo"
    const originFarmInformation = "Cape Town"
    const originFarmLatitude = "33.9249"
    const originFarmLongitude = "18.4241"
    var productID = sku + upc
    const productNotes = "Amazing Grapes"
